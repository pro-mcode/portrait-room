    ...
    <section id="newsletter" className="review py-24">
      <div className="layout mx-auto">
        <div className="relative bg-black/95 flex flex-col justify-center items-center py-20 px-4 md:px-20">
          ...
          {/* <div className="box bg-primary/5 h-48 w-24 absolute top-0 left-0"></div>
          <div className="box rounded-md bg-primary/5 h-18 w-18 absolute top-10 left-50"></div>
          <div className="box rounded-md bg-primary/5 h-18 w-18 absolute top-20 left-60"></div>
          <div className="box rounded-md bg-primary/5 h-18 w-18 absolute bottom-10 right-50"></div>
          <div className="box rounded-md bg-primary/5 h-18 w-18 absolute bottom-20 right-60"></div>
          <div className="box bg-primary/5 h-48 w-24 absolute bottom-0 right-0"></div> */}
          {shapes.map((shape, i) => (
